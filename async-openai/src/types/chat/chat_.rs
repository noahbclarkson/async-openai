...
pub struct ChatCompletionRequestAssistantMessage {
    ...
    /// Reasoning content to echo back for multi-turn conversations with reasoning models.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reasoning_content: Option<String>,

    /// Structured reasoning details to echo back for multi-turn tool calling.
...
pub struct ChatCompletionResponseMessage {
    ...
    /// Reasoning content from reasoning-capable models (e.g., DeepSeek, Gemini via OpenRouter).
    /// Contains the model's chain-of-thought text.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reasoning_content: Option<String>,

    /// Structured reasoning details from OpenRouter.
    /// Contains typed reasoning objects (text with signatures, summaries, encrypted blocks).
    /// Must be passed back unmodified on assistant messages for multi-turn tool calling.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reasoning_details: Option<Vec<serde_json::Value>>,
}
...
pub struct ChatCompletionStreamResponseDelta {
    ...
    /// Reasoning content delta from reasoning-capable models.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reasoning_content: Option<String>,

    /// Structured reasoning details delta from OpenRouter.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reasoning_details: Option<Vec<serde_json::Value>>,
}
